/**
 * Interface for creating an image using OpenAI's API.
 ...
 * @param {string} [mask] - An additional image whose fully transparent areas indicate where image should be edited. Must be a valid PNG file, less than 4MB, and have the same dimensions as image.
 * @param {string} prompt - A text description of the desired image(s). The maximum length is 1000 characters.
 * @param {number|null} [n=1] - The number of images to generate. Must be between 1 and 10.
 * @param {string|null} [size='1024x1024'] - The size of the generated images. Must be one of 256x256, 512x512, or 1024x1024.
 * @param {string|null} [response_format='url'] - The format in which the generated images are returned. Must be one of url or b64_json.
